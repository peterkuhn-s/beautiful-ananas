...
\label{zweitFeldVer}
Ziel des zweiten Versuchs \ref{fig:DavosMessung} war es, den Ablauf der Tape-Messung bei verschiedenen LWC-Werten zu testen. Dazu wurde Schnee einmal mit Wasser übergossen und einmal mit Kältespray eingefroren. \ref{fig:DavosMessung} Die Wärmebildaufnahme \ref{fig:KaltSchnee} zeigte, dass der Schnee sich nur sehr langsam aufwärmte, da er gut isoliert war. 
