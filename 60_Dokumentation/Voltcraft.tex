Um den elektrischen Widerstand von Schnee zu messen, wurde der Kontaktpunkt eines Leitwertmessgeräts mit zwei angewinkelten Stahlplatten modifiziert, um einen guten flächigen Kontakt mit dem Schnee zu ermöglichen.
...
Die Hypothese ist, dass sowohl die Verunreinigungen durch die Nuklei des Schnees als auch die spontan entstehenden Hydronium Ionen keine genügend Leitfähigkeit bilden,  um einen Messwert im \si{\micro\siemens} (Siemens = \si{1/\ohm}) Bereich zu erhalten. \cite{Scholz.2020}
